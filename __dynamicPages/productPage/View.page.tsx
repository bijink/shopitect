import { Box, capitalize, CircularProgress, Stack, Typography } from '@mui/material';
...
import { ProductTypes } from '../../__types/pages/productView.types';
...
const ProductView_page = () => {
  ...
  useEffect(() => {
    if (productId && shop) {
      getDoc(doc(database, 'shops', shop.urlName, 'products', productId.toString())).then(
        (snap) => {
      ...
      {!productId || !prodDetails ? (
        ...
        >
          <Box width="100%" display="flex" justifyContent="center" alignItems="center">
            <img src={prodDetails.imageUrl} width="100%" style={{ borderRadius: '4px' }} />
          </Box>

          <Box width="100%" display="flex" alignItems="center" px={2} py={{ xs: 2, sm: 0 }}>
