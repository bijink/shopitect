...
import { sidebarWidth } from '../../__layouts/Page.layout';
import { useAppDispatch, useAppSelector } from '../../__redux/hooks';
import { selectPageId } from '../../__redux/slices/pageId.slice';
import { setProdSearchInput } from '../../__redux/slices/prodSearchInput.slice';
      ...
      >
        ...
        <Box sx={{ overflow: 'auto' }}>
          <List sx={{ padding: 0 }}>
            ...
            {(pageId === 'shopHome_page' || pageId === 'productTable_page') &&
